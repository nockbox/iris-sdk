 ...
 */
import type { NockchainTx, Nicks, NoteV0, PbCom2Balance, RawTx, SpendCondition } from '@nockbox/iris-wasm/iris_wasm.js';
export type { Nicks };
...
export interface BuildV0MigrationFromMnemonicParams extends QueryV0BalanceFromMnemonicParams, Omit<BuildV0MigrationTransactionParams, 'v0Notes'> {
}
